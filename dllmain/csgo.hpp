...
constexpr ptrdiff_t dwEntityList = 0x4DDD91C;
constexpr ptrdiff_t dwForceAttack = 0x320DE3C;
constexpr ptrdiff_t dwForceAttack2 = 0x320DE48;
constexpr ptrdiff_t dwForceBackward = 0x320DDE8;
constexpr ptrdiff_t dwForceForward = 0x320DE6C;
constexpr ptrdiff_t dwForceJump = 0x52878FC;
constexpr ptrdiff_t dwForceLeft = 0x320DDF4;
constexpr ptrdiff_t dwForceRight = 0x320DE00;
constexpr ptrdiff_t dwGameDir = 0x62B900;
constexpr ptrdiff_t dwGameRulesProxy = 0x52FB12C;
constexpr ptrdiff_t dwGetAllClasses = 0xDEBCAC;
constexpr ptrdiff_t dwGlobalVars = 0x58CCE0;
constexpr ptrdiff_t dwGlowObjectManager = 0x5326620;
constexpr ptrdiff_t dwInput = 0x522EEF0;
constexpr ptrdiff_t dwInterfaceLinkList = 0x970754;
constexpr ptrdiff_t dwLocalPlayer = 0xDC14CC;
constexpr ptrdiff_t dwMouseEnable = 0xDC71D8;
constexpr ptrdiff_t dwMouseEnablePtr = 0xDC71A8;
constexpr ptrdiff_t dwPlayerResource = 0x320C180;
constexpr ptrdiff_t dwRadarBase = 0x5212694;
constexpr ptrdiff_t dwSensitivity = 0xDC7074;
constexpr ptrdiff_t dwSensitivityPtr = 0xDC7048;
constexpr ptrdiff_t dwSetClanTag = 0x8A410;
constexpr ptrdiff_t dwViewMatrix = 0x4DCF234;
constexpr ptrdiff_t dwWeaponTable = 0x522F9B4;
constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
constexpr ptrdiff_t dwYawPtr = 0xDC6E38;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDCD620;
constexpr ptrdiff_t dwbSendPackets = 0xD8622;
constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA6050;
constexpr ptrdiff_t m_pStudioHdr = 0x2950;
constexpr ptrdiff_t m_yawClassPtr = 0xDC6E38;
constexpr ptrdiff_t m_pitchClassPtr = 0x5212930;
...
constexpr ptrdiff_t set_abs_angles = 0x1E5AB0;
constexpr ptrdiff_t set_abs_origin = 0x1E58F0;
constexpr ptrdiff_t is_c4_owner = 0x3CB620;
constexpr ptrdiff_t force_update_spectator_glow = 0x3BE59A;
constexpr ptrdiff_t anim_overlays = 0x2990;
constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
constexpr ptrdiff_t find_hud_element = 0x316F5CF0;
