...
namespace offsets
{
	...
	constexpr ptrdiff_t dwEntityList = 0x4DDD92C;
	constexpr ptrdiff_t dwForceAttack = 0x320DE4C;
	constexpr ptrdiff_t dwForceAttack2 = 0x320DE58;
	constexpr ptrdiff_t dwForceBackward = 0x320DDF8;
	constexpr ptrdiff_t dwForceForward = 0x320DE7C;
	constexpr ptrdiff_t dwForceJump = 0x528790C;
	constexpr ptrdiff_t dwForceLeft = 0x320DE04;
	constexpr ptrdiff_t dwForceRight = 0x320DE10;
	constexpr ptrdiff_t dwGameDir = 0x62B900;
	constexpr ptrdiff_t dwGameRulesProxy = 0x52FB13C;
	constexpr ptrdiff_t dwGetAllClasses = 0xDEBC9C;
	constexpr ptrdiff_t dwGlobalVars = 0x58CCE0;
	constexpr ptrdiff_t dwGlowObjectManager = 0x53265E8;
	constexpr ptrdiff_t dwInput = 0x522EF00;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x9704F4;
	constexpr ptrdiff_t dwLocalPlayer = 0xDC14BC;
	constexpr ptrdiff_t dwMouseEnable = 0xDC71C8;
	constexpr ptrdiff_t dwMouseEnablePtr = 0xDC7198;
	constexpr ptrdiff_t dwPlayerResource = 0x320C190;
	constexpr ptrdiff_t dwRadarBase = 0x52126A4;
	constexpr ptrdiff_t dwSensitivity = 0xDC7064;
	constexpr ptrdiff_t dwSensitivityPtr = 0xDC7038;
	constexpr ptrdiff_t dwSetClanTag = 0x8A410;
	constexpr ptrdiff_t dwViewMatrix = 0x4DCF244;
	constexpr ptrdiff_t dwWeaponTable = 0x522F9C4;
	constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
	constexpr ptrdiff_t dwYawPtr = 0xDC6E28;
	constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDCD610;
	constexpr ptrdiff_t dwbSendPackets = 0xD85A2;
	constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA6050;
	constexpr ptrdiff_t m_pStudioHdr = 0x2950;
	constexpr ptrdiff_t m_yawClassPtr = 0xDC6E28;
	constexpr ptrdiff_t m_pitchClassPtr = 0x5212940;
	...
	constexpr ptrdiff_t is_c4_owner = 0x3CB4E0;
	constexpr ptrdiff_t force_update_spectator_glow = 0x3BE47A;
	constexpr ptrdiff_t anim_overlays = 0x2990;
	constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
	constexpr ptrdiff_t find_hud_element = 0x360F5C30;
